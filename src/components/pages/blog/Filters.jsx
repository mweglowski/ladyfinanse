...
const Filters = ({
  ...
  return (
    <div className="mt-[100px] p-2 rounded-lg border-2 border-slate-200 mb-4 max-w-[1000px] w-full mx-auto">
      <div className="font-bold text-lg border-b-2 border-slate-200 mb-2">
        Filtry
      </div>
