  ...
  return (
    <Section classNames="text-white bg-[#1a1a1a]">
      <Title classNames="text-shadow-white max-w-[500px] text-[42px] sm:text-[54px] mt-[150px]">
        {postId || id ? "Co zamierzasz zmienić?" : "Co dzisiaj chciałabyś opisać?"}
      </Title>
      <form
      ...
      >
        ...
        <div className="flex flex-col">
          ...
          <div className="flex gap-2 mx-auto mt-[15px]">
            <button
              type="button"
              className={`border-2 p-1 px-3 border-gray-600 rounded-lg duration-300 text-gray-400 ${
          ...
          {newSectionType === "text" && (
            <div className="flex gap-2 mx-auto mt-4">
              <button
                type="button"
                onClick={handleBoldText}
                className="border-2 p-1 px-3 border-gray-600 rounded-lg text-gray-400 active:border-transparent active:text-white active:bg-black duration-300"
              >
                Pogrubienie
              </button>
            </div>
          ...
          <button
            ...
            className="px-4 py-2 mx-auto button rounded-b-lg"
          >
            Dodaj Element
          </button>
        </div>
        ...
        <div className="mt-4 flex flex-col">
          <div className="flex flex-wrap gap-2 mb-2">
            {categories.map((category, index) => (
              <div
                key={index}
                className="flex items-center border-2 border-gray-600 rounded-lg"
              >
                <span className="bg-gray-700 p-2 rounded-l-md rounded-r-md text-gray-200">
                  {category}
                </span>
                <button
                  type="button"
          ...
          <button
            ...
            className="mx-auto button rounded-b-lg px-4 py-2"
          >
            Dodaj Kategorię
          </button>
        </div>
